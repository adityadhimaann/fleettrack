  ...
  <div class="max-w-md w-full mx-auto bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
    ...
    <div class="p-8">
      ...
      <div class="text-center mt-4">
        <a href="http://localhost/tailwindcssproject/vehicle_list.php" class="text-blue-600 hover:text-blue-800 text-sm font-medium underline">Cancel and return to vehicle list</a>
      </div>
    </div>
  </div>
</body>
