...
// JavaScript for the home button functionality
document.addEventListener('DOMContentLoaded', function() {
    ...
    homeButton.addEventListener('click', function(event) {
      ...
      window.location.href = '/dashboard'; // Change this to your actual home page URL
      
      // Or if you're using a single page application approach:
  ...
  // Example function for single page applications
  function loadDashboardContent() {
    ...
    if (mainContent) {
      ...
      mainContent.innerHTML = '<div class="flex justify-center"><span class="loading">Loading dashboard...</span></div>';
      ...
      fetch('/api/dashboard')
        ...
        .catch(error => {
          ...
          mainContent.innerHTML = '<div class="text-red-500">Error loading dashboard content</div>';
        });
    }
  }
  ...
  function renderDashboard(data) {
   ...
   // JavaScript for the home button
   document.addEventListener('DOMContentLoaded', function() {
    const homeBtn = document.getElementById('homeBtn');
    
    homeBtn.addEventListener('click', function(event) {
        event.preventDefault();
        console.log('Home button clicked - already on dashboard');
        // No navigation needed since we're already on the home page
    });
});